...
import { Building2, Settings, LogOut, Shield, Server, BookOpen, BarChart3, LineChart } from "lucide-react";
...
const navItems = [
    ...
    { href: "/admin/event-metrics", label: "Event Metrics", icon: LineChart },
