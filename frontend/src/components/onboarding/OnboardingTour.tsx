...
const STEPS: TourStep[] = [
    {
        ...
        description: "Em menos de 2 minutos você vai conhecer tudo que a plataforma oferece. Tudo aqui foi criado para te aproximar da aprovação.",
    ...
    },
    {
        ...
        description: "Ficou perdido ou sem saber o que fazer? Clique aqui a qualquer momento. Seu Mentor Inteligente analisa seu contexto e te diz exatamente qual é o próximo passo.",
    ...
    },
    {
        ...
        description: "Veja seu desempenho por disciplina, identifique pontos fracos e acompanhe sua evolução ao longo do tempo com insights gerados pelo seu Mentor Inteligente.",
