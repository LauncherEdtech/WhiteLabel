...
export default function TenantLoginPage() {
  ...
  // Garante que o cookie de tenant reflete a URL atual
  useEffect(() => {
    if (tenantSlug) {
    ...
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-primary flex-col justify-between p-12">
        ...
        <div className="flex items-center gap-6">
          {[{ value: "10k+", label: "Aprovados" }, { value: "50k+", label: "Questões" }, { value: "98%", label: "Satisfação" }].map(({ value, label }) => (
            <div key={label}>
      ...
      <div className="flex-1 flex items-center justify-center p-8 bg-background">
        <div className="w-full max-w-sm">
          ...
          <div className="mb-8">
            ...
            <p className="text-muted-foreground text-sm mt-1">Acesse sua conta para continuar estudando.</p>
          </div>
