...
export interface Lesson { id:string;title:string;description?:string;video_url?:string;material_url?:string;duration_minutes:number;order:number;is_published:boolean;is_free_preview:boolean;has_ai_summary:boolean;ai_summary?:string;ai_topics?:string[];progress?:LessonProgress; }
